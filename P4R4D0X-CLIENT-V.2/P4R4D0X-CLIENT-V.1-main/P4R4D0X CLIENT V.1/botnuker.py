...
╚═╝          ╚═╝╚═╝  ╚═╝     ╚═╝╚═════╝  ╚═════╝ ╚═╝  ╚═╝     ╚═════╝╚══════╝╚═╝╚══════╝╚═╝  ╚═══╝   ╚═╝ 
    ...
    print(
            ...
            Colorate.Vertical(
                Colors.cyan_to_blue,   
                f"""x,.-> P4R4D0X CLIENT V.1
x,.-> made by P4R4D0X#5353

Prefix - "{prefix}"
Discord - https://discord.gg/KqFDZy4HaS
...
async def delchans(ctx):
    ...
    await ctx.guild.create_text_channel(name='MADE BY P4R4D0X#5353')
...
async def nuke(ctx, *, message):
    ...
    async def make_alot_chans(ctx):
        channel = await ctx.guild.create_text_channel(name='P4R4D0X#5353')
        with ThreadPoolExecutor() as executor:
...
╚══════╝╚═╝  ╚═╝╚═╝  ╚═╝ ╚═════╝ ╚═╝  ╚═╝ 
    ...
    x,.- contact P4R4D0X#5353 or join https://discord.gg/KqFDZy4HaS for help
    """,
                1,
            )
        )
